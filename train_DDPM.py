...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_test_example', help='save test examples to save_dir and wandb', action='store_true', default=False)
    parser.add_argument('--wandb_log', help='disable wandb logging', action='store_true', default=False)
