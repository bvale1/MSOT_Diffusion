...
class DiT(nn.Module):
    """
    Diffusion model with a Transformer backbone. Modified to support image conditioning
    """
    def __init__(
        self,
        ...
        super().__init__()
        # removed to use with denoising_diffusion_python.GaussianDiffusion class
        ...
        self.final_layer = FinalLayer(hidden_size, patch_size, self.dim_out)
